...
call_lambda0(lambda0_88(B,C,A)):-public_0_find(A,B,C).
call_lambda0(lambda0_79(A)):-public_0_yolo_UNSAFE_format_shim('Syntax error in clause: ~w~n~n',[A]).
call_lambda0(lambda0_78(B,A)):-private_2_yolo_UNSAFE_translate_clause(A,B).
call_lambda0(lambda0_77(A)):-public_0_yolo_UNSAFE_format_shim('Syntax error in type: ~w~n~n',[A]).
call_lambda0(lambda0_76(B,C,A)):-private_2_yolo_UNSAFE_translate_type(A,B,C).
call_lambda0(lambda0_74(A)):-public_0_yolo_UNSAFE_format_shim('Syntax error in term: ~w~n~n',[A]).
call_lambda0(lambda0_73(B,A)):-private_2_yolo_UNSAFE_translate_term(A,B).
call_lambda0(lambda0_71(A)):-public_0_yolo_UNSAFE_format_shim('Syntax error in body: ~w~n~n',[A]).
call_lambda0(lambda0_70(B,A)):-private_2_yolo_UNSAFE_translate_body(A,B).
call_lambda0(lambda0_50(A)):-public_0_duplicates(A,B),public_0_yolo_UNSAFE_format_shim('Duplicate constructors in scope: ~w~n',[B]).
call_lambda0(lambda0_49(A)):-is_set(A).
call_lambda0(lambda0_47(C,B,A)):-public_0_yolo_UNSAFE_format_shim('Something exported not defined in: ~w~n',[A]),public_0_yolo_UNSAFE_format_shim('Nonexistent clauses are: ~w~n',[B]),public_0_yolo_UNSAFE_format_shim('Nonexistent types are: ~w~n',[C]).
call_lambda0(lambda0_46(B,A)):-A=[],B=[].
...
call_lambda1(lambda1_87(A),B):-public_0_setContains(A,B).
call_lambda1(lambda1_85(A),B):-public_0_forall(A,lambda1_84(B)).
call_lambda1(lambda1_84(B),A):-private_1_yolo_UNSAFE_write_clause(A,B).
call_lambda1(lambda1_83(B,C),A):-private_1_read_clauses_from_stream(A,B,C).
call_lambda1(lambda1_82(F,A,B),D):-private_1_yolo_UNSAFE_read_clause(A,B,C), (C=public_0_some(E)->D=[E|G],call_lambda1(F,G);D=[]).
call_lambda1(lambda1_69,A):-atom(A).
call_lambda1(lambda1_68,A):-var(A).
call_lambda1(lambda1_45(A),B):- \+public_0_existsOnce(A,lambda1_44(B)).
call_lambda1(lambda1_44(A),public_2_defdata(A,_,_)).
call_lambda1(lambda1_43(A),public_0_pair(B,C)):- \+public_0_existsOnce(A,lambda1_42(B,C)).
call_lambda1(lambda1_42(A,C),public_2_defclause(A,_,B)):-length(B,C).
call_lambda1(lambda1_40(B),A):-member(A,B).
...
call_lambda2(lambda2_81,A,B):-private_2_translateClause(A,B).
call_lambda2(lambda2_80(C),A,public_2_typeConstructor(B,E)):-A=..[B|D],private_2_translateTypes(C,D,E).
call_lambda2(lambda2_75(A),B,C):-private_2_translateType(A,B,C).
call_lambda2(lambda2_72,A,B):-private_2_translateTerm(A,B).
call_lambda2(lambda2_67,A/B,public_0_pair(A,B)):-atom(A),number(B).
call_lambda2(lambda2_65(B),public_2_clauseclause(C,A,G),public_2_clauseclause(E,F,H)):-length(A,D),private_3_renamedClause(B,C,D,E),private_3_translateTerms(B,A,F),private_3_translateBody(B,G,H).
call_lambda2(lambda2_64(B),public_2_defglobalvar(C,A,E),public_2_defglobalvar(D,A,F)):-private_3_renamedGlobalVariable(B,C,D),private_3_translateType(B,E,F).
call_lambda2(lambda2_63(C),public_2_defclause(D,A,B),public_2_defclause(F,A,G)):-length(B,E),private_3_renamedClause(C,D,E,F),private_3_translateTypes(C,B,G).
call_lambda2(lambda2_62(A),B,C):-private_3_translateDataDef(A,B,C).
call_lambda2(lambda2_61(A),public_2_typeConstructor(B,D),public_2_typeConstructor(C,E)):-private_3_renamedConstructor(A,B,C),private_3_translateTypes(A,D,E).
call_lambda2(lambda2_60(A),B,C):-private_3_translateType(A,B,C).
call_lambda2(lambda2_59(A),B,C):-private_3_translateTerm(A,B,C).
call_lambda2(lambda2_58(B),public_2_defglobalvar(A,_,_),public_0_pair(A,C)):-private_3_yolo_UNSAFE_mangled_name(private_3_mod_private,B,A,C).
call_lambda2(lambda2_56(C,B),public_2_typeConstructor(A,_),public_0_pair(A,D)):-private_3_yolo_UNSAFE_mangled_name(B,C,A,D).
call_lambda2(lambda2_55(F,D),public_2_defclause(A,_,B),public_0_pair(public_0_pair(A,C),G)):-length(B,C), (member(public_0_pair(A,C),D)->E=private_3_mod_public;E=private_3_mod_private),private_3_yolo_UNSAFE_mangled_name(E,F,A,G).
...
call_lambda2(lambda2_51(B),A,public_0_pair(A,D)):-A=public_0_pair(C,_),private_3_yolo_UNSAFE_mangled_name(private_3_mod_public,B,C,D).
call_lambda2(lambda2_41(C),B,A):-A=public_2_defdata(B,_,_),member(A,C).
...
call_lambda3(lambda3_86(A),B,D,E):-call_lambda2(A,B,C),append(C,D,E).
call_lambda3(lambda3_66(A),public_0_tup4(C,E,G,I),B,public_0_tup4(D,F,H,J)):-private_3_translateModule(A,B,C,D,E,F,G,H,I,J).
call_lambda3(lambda3_57(E,C),public_2_defdata(A,_,G),public_0_pair(B,I),public_0_pair([public_0_pair(A,F)|B],J)):- (member(A,C)->D=private_3_mod_public;D=private_3_mod_private),private_3_yolo_UNSAFE_mangled_name(D,E,A,F),public_0_map(G,lambda2_56(E,D),H),append(H,I,J).
call_lambda3(lambda3_54(K),private_3_moduleUse(B,A,F),public_0_tup3(D,H,N),public_0_tup3(E,I,O)):-public_0_map(A,lambda2_51(B),C),append(C,D,E),public_0_map(F,lambda2_52(B),G),append(G,H,I),J=private_3_loadedModule(_,B,_,_),member(J,K),private_3_extractConstructors(J,F,L),public_0_map(L,lambda2_53(B),M),append(M,N,O).
call_lambda3(lambda3_48(H,E),public_0_pair(G,[private_3_moduleUse(J,A,B)|C]),public_2_def_use_module(D,A,B),public_0_pair(I,C)):-private_3_yolo_UNSAFE_absolute_file_name(D,E,F),private_3_loadModule(F,G,H,I),member(private_3_loadedModule(F,J,_,_),I).
...
private_3_extractConstructors(private_3_loadedModule(_,_,_,A),B,F):-A=public_2_loadedFile(public_2_defmodule(_,_,C),_,D,_,_,_),public_0_forall(B,lambda1_40(C)),public_0_map(B,lambda2_41(D),E),private_3_constructorsInDataDefs(E,F).
private_3_nonexistentExports(public_2_loadedFile(public_2_defmodule(_,A,D),_,E,B,_,_),C,F):-public_0_filter(A,lambda1_43(B),C),public_0_filter(D,lambda1_45(E),F).
private_3_ensureEverythingExportedIsDefined(D,A):-private_3_nonexistentExports(A,C,B),public_0_onFailure(lambda0_46(B,C),lambda0_47(B,C,D)).
private_3_directLoadModule(A,D,F,[private_3_loadedModule(A,L,E,B)|G]):-public_2_loadFile(A,B),B=public_2_loadedFile(_,C,H,_,_,_),private_3_ensureEverythingExportedIsDefined(A,B),public_0_foldLeft(C,public_0_pair(D,E),lambda3_48(F,A),public_0_pair(G,[])),private_3_allImportedConstructors(G,E,I),private_3_constructorsInDataDefs(H,J),append(I,J,K),public_0_onFailure(lambda0_49(K),lambda0_50(K)),private_3_freshModuleId(L).
...
private_3_makeRenaming(C,private_3_loadedModule(_,E,B,A),private_3_renaming(M,P,S,J)):-A=public_2_loadedFile(public_2_defmodule(_,F,H),_,G,D,I,_),public_0_foldRight(B,public_0_tup3([],[],[]),lambda3_54(C),public_0_tup3(L,O,R)),public_0_map(D,lambda2_55(E,F),K),public_0_foldRight(G,public_0_pair([],[]),lambda3_57(E,H),public_0_pair(N,Q)),public_0_map(I,lambda2_58(E),J),append(K,L,M),append(N,O,P),append(Q,R,S).
...
private_3_translateTerms(B,A,C):-public_0_map(A,lambda2_59(B),C).
...
private_3_translateTypes(B,A,C):-public_0_map(A,lambda2_60(B),C).
...
private_3_translateDataDef(B,public_2_defdata(C,A,E),public_2_defdata(D,A,F)):-private_3_renamedType(B,C,D),public_0_map(E,lambda2_61(B),F).
private_3_translateLoadedFile(B,public_2_loadedFile(_,_,A,F,J,N),D,E,H,I,L,M,P,Q):-public_0_map(A,lambda2_62(B),C),public_0_appendDiffList(C,D,E),public_0_map(F,lambda2_63(B),G),public_0_appendDiffList(G,H,I),public_0_map(J,lambda2_64(B),K),public_0_appendDiffList(K,L,M),public_0_map(N,lambda2_65(B),O),public_0_appendDiffList(O,P,Q).
...
public_3_handleModules(A,D,E,F,G):-nb_setval(private_3_counter,0),private_3_yolo_UNSAFE_absolute_file_name(A,./,B),private_3_directLoadModule(B,[],[B],C),!,public_0_foldLeft(C,public_0_tup4(D,E,F,G),lambda3_66(C),public_0_tup4([],[],[],[])).
private_2_yolo_UNSAFE_translate_pairs(A,B):-public_0_map(A,lambda2_67,B).
private_2_areTypeVars(A):-public_0_forall(A,lambda1_68),is_set(A).
private_2_yolo_UNSAFE_allAtoms(A):-public_0_forall(A,lambda1_69).
...
private_2_translateBody(B,A):-public_0_onFailure(lambda0_70(A,B),lambda0_71(B)).
...
private_2_translateTerms(A,B):-public_0_map(A,lambda2_72,B).
private_2_translateTerm(B,A):-public_0_onFailure(lambda0_73(A,B),lambda0_74(B)).
...
private_2_translateTypes(B,A,C):-public_0_map(A,lambda2_75(B),C).
...
private_2_translateType(C,A,B):-public_0_onFailure(lambda0_76(A,B,C),lambda0_77(A)).
private_2_translateClause(B,A):-public_0_onFailure(lambda0_78(A,B),lambda0_79(B)).
...
private_2_yolo_UNSAFE_translate_clause(A,private_2_readDefData(public_2_defdata(B,C,E))):-A=datadef(B,C,D),!,atom(B),private_2_areTypeVars(C),public_0_map(D,lambda2_80(C),E).
...
public_2_loadFile(A,public_2_loadedFile(C,D,E,F,G,H)):-public_1_read_clauses_from_file(A,lambda2_81,B),private_2_sortClauses(B,[C],[],D,[],E,[],F,[],G,[],H,[]).
...
private_1_read_clauses_from_stream(B,C,D):-A=lambda1_82(A,B,C),call_lambda1(A,D).
public_1_read_clauses_from_file(A,B,C):-private_1_withOpenStream(A,private_1_read_mode,lambda1_83(B,C)).
...
public_1_writeClauses(B,A):-private_1_withOpenStream(A,private_1_write_mode,lambda1_85(B)).
public_0_map([],_,[]).
public_0_map([B|D],A,[C|E]):-call_lambda2(A,B,C),public_0_map(D,A,E).
public_0_flatMap(A,B,C):-public_0_foldRight(A,[],lambda3_86(B),C).
public_0_filter([],_,[]).
...
public_0_setsOverlap(A,B):-public_0_existsOnce(A,lambda1_87(B)).
...
private_0_findOnce(C,A,B):-public_0_once(lambda0_88(A,B,C)).
