...
private_4_builtinClauseDefs([public_2_defclause(true,[],[]),public_2_defclause(false,[],[]),public_2_defclause(fail,[],[]),public_2_defclause(!,[],[]),public_2_defclause(var,[A],[A]),public_2_defclause(nonvar,[A],[A]),public_2_defclause(atom,[A],[A]),public_2_defclause(integer,[],[public_2_intType]),public_2_defclause(>,[],[public_2_intType,public_2_intType]),public_2_defclause(<,[],[public_2_intType,public_2_intType]),public_2_defclause(=<,[],[public_2_intType,public_2_intType]),public_2_defclause(>=,[],[public_2_intType,public_2_intType]),public_2_defclause(@>,[A],[A,A]),public_2_defclause(@<,[A],[A,A]),public_2_defclause(@=<,[A],[A,A]),public_2_defclause(@>=,[A],[A,A]),public_2_defclause(=,[A],[A,A]),public_2_defclause(\=,[A],[A,A]),public_2_defclause(#>,[],[public_2_intType,public_2_intType]),public_2_defclause(#<,[],[public_2_intType,public_2_intType]),public_2_defclause(#=<,[],[public_2_intType,public_2_intType]),public_2_defclause(#>=,[],[public_2_intType,public_2_intType]),public_2_defclause(#=,[],[public_2_intType,public_2_intType]),public_2_defclause(#\=,[],[public_2_intType,public_2_intType]),public_2_defclause(fd_labeling,[],[public_2_constructorType(list,[public_2_intType])]),public_2_defclause(==,[A],[A,A]),public_2_defclause(\==,[A],[A,A]),public_2_defclause(is_set,[A],[public_2_constructorType(list,[A])]),public_2_defclause(member,[A],[A,public_2_constructorType(list,[A])]),public_2_defclause(reverse,[A],[public_2_constructorType(list,[A]),public_2_constructorType(list,[A])]),public_2_defclause(copy_term,[A],[A,A]),public_2_defclause(append,[A],[public_2_constructorType(list,[A]),public_2_constructorType(list,[A]),public_2_constructorType(list,[A])]),public_2_defclause(length,[A],[public_2_constructorType(list,[A]),public_2_intType]),public_2_defclause(atom_codes,[],[public_2_atomType,public_2_constructorType(list,[public_2_intType])])]).
