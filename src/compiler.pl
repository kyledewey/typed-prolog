call_lambda0(lambda0_60(A)):-public_0_yolo_UNSAFE_format_shim('Syntax error in clause: ~w~n',[A]).
call_lambda0(lambda0_59(B,A)):-private_2_yolo_UNSAFE_translate_clause(A,B).
call_lambda0(lambda0_58(A)):-public_0_yolo_UNSAFE_format_shim('Syntax error in type: ~w~n',[A]).
call_lambda0(lambda0_57(B,C,A)):-private_2_yolo_UNSAFE_translate_type(A,B,C).
call_lambda0(lambda0_55(A)):-public_0_yolo_UNSAFE_format_shim('Syntax error in term: ~w~n',[A]).
call_lambda0(lambda0_54(B,A)):-private_2_yolo_UNSAFE_translate_term(A,B).
call_lambda0(lambda0_52(A)):-public_0_yolo_UNSAFE_format_shim('Syntax error in body: ~w~n',[A]).
call_lambda0(lambda0_51(B,A)):-private_2_yolo_UNSAFE_translate_body(A,B).
...
call_lambda1(lambda1_68(A),B):-A\=B.
call_lambda1(lambda1_66(A),B):-public_0_forall(A,lambda1_65(B)).
call_lambda1(lambda1_65(B),A):-private_1_yolo_UNSAFE_write_clause(A,B).
call_lambda1(lambda1_64(B,C),A):-private_1_read_clauses_from_stream(A,B,C).
call_lambda1(lambda1_63(F,A,B),D):-private_1_yolo_UNSAFE_read_clause(A,B,C), (C=public_0_some(E)->D=[E|G],call_lambda1(F,G);D=[]).
call_lambda1(lambda1_50,A):-atom(A).
call_lambda1(lambda1_49,A):-var(A).
...
call_lambda2(lambda2_74,public_0_pair(A,_),A).
call_lambda2(lambda2_72(A),public_0_pair(_,B),public_0_pair(_,C)):-call_lambda2(A,B,C).
call_lambda2(lambda2_71(B),A,public_0_pair(A,C)):-call_lambda2(B,A,C).
call_lambda2(lambda2_62,A,B):-private_2_translateClause(A,B).
call_lambda2(lambda2_61(C),A,public_2_typeConstructor(B,E)):-A=..[B|D],private_2_translateTypes(C,D,E).
call_lambda2(lambda2_56(A),B,C):-private_2_translateType(A,B,C).
call_lambda2(lambda2_53,A,B):-private_2_translateTerm(A,B).
call_lambda2(lambda2_48,A/B,public_0_pair(A,B)):-atom(A),number(B).
call_lambda2(lambda2_46(B),public_2_clauseclause(C,A,G),public_2_clauseclause(E,F,H)):-length(A,D),private_3_renamedClause(B,C,D,E),private_3_translateTerms(B,A,F),private_3_translateBody(B,G,H).
call_lambda2(lambda2_45(B),public_2_defglobalvar(C,A,E),public_2_defglobalvar(D,A,F)):-private_3_renamedGlobalVariable(B,C,D),private_3_translateType(B,E,F).
call_lambda2(lambda2_44(C),public_2_defclause(D,A,B),public_2_defclause(F,A,G)):-length(B,E),private_3_renamedClause(C,D,E,F),private_3_translateTypes(C,B,G).
call_lambda2(lambda2_43(A),B,C):-private_3_translateDataDef(A,B,C).
call_lambda2(lambda2_42(A),public_2_typeConstructor(B,D),public_2_typeConstructor(C,E)):-private_3_renamedConstructor(A,B,C),private_3_translateTypes(A,D,E).
call_lambda2(lambda2_41(A),B,C):-private_3_translateType(A,B,C).
call_lambda2(lambda2_40(A),B,C):-private_3_translateTerm(A,B,C).
call_lambda2(lambda2_39(B),public_2_defglobalvar(A,_,_),public_0_pair(A,C)):-private_3_yolo_UNSAFE_mangled_name(private_3_mod_private,B,A,C).
call_lambda2(lambda2_37(C,B),public_2_typeConstructor(A,_),public_0_pair(A,D)):-private_3_yolo_UNSAFE_mangled_name(B,C,A,D).
call_lambda2(lambda2_36(F,D),public_2_defclause(A,_,B),public_0_pair(public_0_pair(A,C),G)):-length(B,C), (member(public_0_pair(A,C),D)->E=private_3_mod_public;E=private_3_mod_private),private_3_yolo_UNSAFE_mangled_name(E,F,A,G).
call_lambda2(lambda2_34(B),A,public_0_pair(A,C)):-private_3_yolo_UNSAFE_mangled_name(private_3_mod_public,B,A,C).
call_lambda2(lambda2_33(B),A,public_0_pair(A,C)):-private_3_yolo_UNSAFE_mangled_name(private_3_mod_public,B,A,C).
call_lambda2(lambda2_32(B),A,public_0_pair(A,D)):-A=public_0_pair(C,_),private_3_yolo_UNSAFE_mangled_name(private_3_mod_public,B,C,D).
...
call_lambda3(lambda3_73(B),A,C,D):-private_0_insertItem(A,B,C,D).
call_lambda3(lambda3_70(A),C,B,D):-public_0_setContains(A,B)->C=D;D=[B|C].
call_lambda3(lambda3_69,A,B,C):-public_0_setContains(A,B)->A=C;C=[B|A].
call_lambda3(lambda3_67(A),B,D,E):-call_lambda2(A,B,C),append(C,D,E).
call_lambda3(lambda3_47(A),public_0_tup4(C,E,G,I),B,public_0_tup4(D,F,H,J)):-private_3_translateModule(A,B,C,D,E,F,G,H,I,J).
call_lambda3(lambda3_38(E,C),public_2_defdata(A,_,G),public_0_pair(B,I),public_0_pair([public_0_pair(A,F)|B],J)):- (member(A,C)->D=private_3_mod_public;D=private_3_mod_private),private_3_yolo_UNSAFE_mangled_name(D,E,A,F),public_0_map(G,lambda2_37(E,D),H),append(H,I,J).
call_lambda3(lambda3_35(K),private_3_moduleUse(B,A,F),public_0_tup3(D,H,N),public_0_tup3(E,I,O)):-public_0_map(A,lambda2_32(B),C),append(C,D,E),public_0_map(F,lambda2_33(B),G),append(G,H,I),J=private_3_loadedModule(_,B,_,_),member(J,K),private_3_extractConstructors(J,F,L),public_0_map(L,lambda2_34(B),M),append(M,N,O).
...
private_3_directLoadModule(A,D,F,[private_3_loadedModule(A,L,E,B)|G]):-public_2_loadFile(A,B),B=public_2_loadedFile(_,C,H,_,_,_),public_0_foldLeft(C,public_0_pair(D,E),lambda3_31(F,A),public_0_pair(G,[])),private_3_allImportedConstructors(G,E,I),private_3_constructorsInDataDefs(H,J),append(I,J,K),is_set(K),private_3_freshModuleId(L).
...
private_3_makeRenaming(C,private_3_loadedModule(_,E,B,A),private_3_renaming(M,P,S,J)):-A=public_2_loadedFile(public_2_defmodule(_,F,H),_,G,D,I,_),public_0_foldRight(B,public_0_tup3([],[],[]),lambda3_35(C),public_0_tup3(L,O,R)),public_0_map(D,lambda2_36(E,F),K),public_0_foldRight(G,public_0_pair([],[]),lambda3_38(E,H),public_0_pair(N,Q)),public_0_map(I,lambda2_39(E),J),append(K,L,M),append(N,O,P),append(Q,R,S).
...
private_3_translateTerms(B,A,C):-public_0_map(A,lambda2_40(B),C).
...
private_3_translateTypes(B,A,C):-public_0_map(A,lambda2_41(B),C).
...
private_3_translateDataDef(B,public_2_defdata(C,A,E),public_2_defdata(D,A,F)):-private_3_renamedType(B,C,D),public_0_map(E,lambda2_42(B),F).
private_3_translateLoadedFile(B,public_2_loadedFile(_,_,A,F,J,N),D,E,H,I,L,M,P,Q):-public_0_map(A,lambda2_43(B),C),public_0_appendDiffList(C,D,E),public_0_map(F,lambda2_44(B),G),public_0_appendDiffList(G,H,I),public_0_map(J,lambda2_45(B),K),public_0_appendDiffList(K,L,M),public_0_map(N,lambda2_46(B),O),public_0_appendDiffList(O,P,Q).
...
public_3_handleModules(A,D,E,F,G):-nb_setval(private_3_counter,0),private_3_yolo_UNSAFE_absolute_file_name(A,./,B),private_3_directLoadModule(B,[],[B],C),!,public_0_foldLeft(C,public_0_tup4(D,E,F,G),lambda3_47(C),public_0_tup4([],[],[],[])).
private_2_yolo_UNSAFE_translate_pairs(A,B):-public_0_map(A,lambda2_48,B).
private_2_areTypeVars(A):-public_0_forall(A,lambda1_49),is_set(A).
private_2_allAtoms(A):-public_0_forall(A,lambda1_50).
...
private_2_translateBody(B,A):-public_0_onFailure(lambda0_51(A,B),lambda0_52(B)).
...
private_2_translateTerms(A,B):-public_0_map(A,lambda2_53,B).
private_2_translateTerm(B,A):-public_0_onFailure(lambda0_54(A,B),lambda0_55(B)).
...
private_2_translateTypes(B,A,C):-public_0_map(A,lambda2_56(B),C).
...
private_2_translateType(C,A,B):-public_0_onFailure(lambda0_57(A,B,C),lambda0_58(A)).
private_2_translateClause(B,A):-public_0_onFailure(lambda0_59(A,B),lambda0_60(B)).
...
private_2_yolo_UNSAFE_translate_clause(A,private_2_readDefData(public_2_defdata(B,C,E))):-A=datadef(B,C,D),!,atom(B),private_2_areTypeVars(C),public_0_map(D,lambda2_61(C),E).
...
public_2_loadFile(A,public_2_loadedFile(C,D,E,F,G,H)):-public_1_read_clauses_from_file(A,lambda2_62,B),private_2_sortClauses(B,[C],[],D,[],E,[],F,[],G,[],H,[]).
...
private_1_read_clauses_from_stream(B,C,D):-A=lambda1_63(A,B,C),call_lambda1(A,D).
public_1_read_clauses_from_file(A,B,C):-private_1_withOpenStream(A,private_1_read_mode,lambda1_64(B,C)).
...
public_1_writeClauses(B,A):-private_1_withOpenStream(A,private_1_write_mode,lambda1_66(B)).
public_0_map([],_,[]).
public_0_map([B|D],A,[C|E]):-call_lambda2(A,B,C),public_0_map(D,A,E).
public_0_flatMap(A,B,C):-public_0_foldRight(A,[],lambda3_67(B),C).
public_0_filter([],_,[]).
...
public_0_notMember(B,A):-public_0_forall(A,lambda1_68(B)).
...
public_0_makeSetFromList(A,B):-public_0_foldLeft(A,[],lambda3_69,B).
public_0_setUnion(A,B,D):-append(A,B,C),public_0_makeSetFromList(C,D).
public_0_setDifference(A,B,C):-public_0_foldLeft(A,[],lambda3_70(B),C).
...
public_0_sortItems(A,B,C,G):-public_0_map(A,lambda2_71(B),D),E=lambda2_72(C),public_0_foldLeft(D,[],lambda3_73(E),F),public_0_map(F,lambda2_74,G).
